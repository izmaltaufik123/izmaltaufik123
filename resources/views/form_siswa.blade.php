                ...
                <form method="post" action="/store_siswa">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sma" placeholder="Nama Sekolah" name="sma">
                    </div>
                    <div class="form-group">
                        <label for="nama">SMP</label>
                        <input type="text" class="form-control" id="smp" placeholder="Nama Sekolah" name="smp">
                    </div>
                    <div class="form-group">
                        <label for="nama">SD</label>
                        <input type="text" class="form-control" id="sd" placeholder="Nama Sekolah" name="sd">
                    </div>
